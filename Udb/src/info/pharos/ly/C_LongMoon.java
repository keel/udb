...
public void GameMain(){
	...
	info.pharos.ly.C_GameMain.cLib.getGameCanvas().SetViewRect(-1024,-2048,1024,1024);
	...
	info.pharos.ly.C_GameMain.cLib.getInput().ReadTouch();
	;
...
public void freeResouce(){
	info.pharos.ly.C_GameMain.cLib.getGameCanvas().FreeAllACT();
	info.pharos.ly.C_GameMain.cLib.getGameCanvas().ViewDark(16);
	return;
}
...
public boolean onKeyDown(int keyCode){
	switch(keyCode){
	case 24: 
	info.pharos.ly.C_GameMain.cLib.getMediaManager().SetSystemVolume(0);
	;
	return true /* 1 */;
	//break;
	case 25: 
	info.pharos.ly.C_GameMain.cLib.getMediaManager().SetSystemVolume(1);
	;
	return false /* 0 */;
	//break;
	...
	//break;
	default:
	info.pharos.ly.C_GameMain.cLib.getInput().onKeyDown(keyCode);
	;
	return true /* 1 */;
	} //end of switch
	//return 1;
...
public boolean onKeyUp(int keyCode){
	...
	//break;
	default:
	info.pharos.ly.C_GameMain.cLib.getInput().onKeyUp(keyCode);
	;
	return true /* 1 */;
	} //end of switch
	//return 1;
...
public boolean onTouchEvent(android.view.MotionEvent evt,int X,int Y){
	...
	case 0: 
	info.pharos.ly.C_GameMain.cLib.getInput().SetTouchDown(X,Y);
	//break;
	case 1: 
	info.pharos.ly.C_GameMain.cLib.getInput().SetTouchUp(X,Y);
	//break;
	case 2: 
	info.pharos.ly.C_GameMain.cLib.getInput().SetTouchMove(X,Y);
	//break;
	} //end of switch
	;
	return true /* 1 */;
