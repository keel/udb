...
static{
	...
	v0v558[0] = info.pharos.ly.C_EVTDashBTN.BTN_Rush00;
	v0v558[1] = info.pharos.ly.C_EVTDashBTN.BTN_Rush00;
	BTN_DashACT = v0v558;
	;
	int[] v1v568 = new int[8];
	v1v568[6] = 4;
	v1v568[7] = 1;
	info.pharos.ly.C_EVTDashBTN.DashBTNSpriteEVT[0] = v1v568;
	int[] v1v431 = new int[8];
	v1v431[6] = 4;
	v1v431[7] = 2;
	info.pharos.ly.C_EVTDashBTN.DashBTNSpriteEVT[1] = v1v431;
...
public C_EVTDashBTN(){
	super();
	this.m_BTNType = 0 /* 0 */;
	this.EVT.ACTPtr = info.pharos.ly.C_EVTDashBTN.BTN_DashACT;
	this.EVT.EVTPtr = info.pharos.ly.C_EVTDashBTN.DashBTNSpriteEVT;
}
...
private void DashBTNTouch(){
	...
	info.pharos.ly.C_Global.g_DashBTNTouch = (info.pharos.ly.C_Global.g_DashBTNTouch | 0x4);
	this.EVT.CurCNT = 0 /* 0 */;
	this.EVT.CurFRM = 1;
	// :cond_0
	}
...
public void CreateDashBTN(info.pharos.ly.C_EVTDashBTN c_DashBTN,int XVal,int YVal){
