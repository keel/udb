...
public info.pharos.gameEngine.GameSound.CSoundPlay[] cSoundPlay;
...
public GameSound(android.content.Context context,int size){
	...
	;
	this.cSoundPlay = new info.pharos.gameEngine.GameSound.CSoundPlay[size];
	int i = 0;
	while (i < size) {
	this.mPlayChannel[i] = -1;
	;
	this.cSoundPlay[i] = new info.pharos.gameEngine.GameSound.CSoundPlay();
	i = (i + 0x1);
	// goto :goto_0
	// :cond_0
	}
