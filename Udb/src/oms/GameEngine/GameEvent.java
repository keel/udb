...
// instance fields
public oms.GameEngine.GameEvent.EventDEF EVT;
...
public GameEvent(){
	super();
	this.EVT = null /* 0 */;
	this.mRc = oms.GameEngine.GameCanvas.GetViewRect();
	;
	this.EVT = new oms.GameEngine.GameEvent.EventDEF();
...
public void CheckEVTFun(oms.GameEngine.GameCanvas canvas){
	android.graphics.Rect rc = oms.GameEngine.GameCanvas.GetViewRect();
...
public void EVTHIT(oms.GameEngine.GameCanvas canvas){
...
public void ExecEVT(oms.GameEngine.GameCanvas canvas){
	if (canvas == null) {
	// :cond_0
	} else {
	if (this.EVT.Valid) {
...
public void ExecRUN(oms.GameEngine.GameCanvas canvas){
	if (canvas == null) {
	// :cond_0
	} else {
	if (this.EVT.Valid) {
...
public void ShowEVENT(oms.GameEngine.GameCanvas canvas){
	if (canvas == null) {
	// :cond_0
	} else {
	if (this.EVT.Valid) {
