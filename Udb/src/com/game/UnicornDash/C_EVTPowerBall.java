...
static{
	...
	v0v318[0] = com.game.UnicornDash.C_EVTPowerBall.PowerBall00;
	v0v318[1] = com.game.UnicornDash.C_EVTPowerBall.PowerBall01;
	v0v318[2] = com.game.UnicornDash.C_EVTPowerBall.PowerBall02;
	PowerBallACT = v0v318;
	;
	int[] v1v366 = new int[8];
	v1v366[6] = 4;
	v1v366[7] = 1;
	com.game.UnicornDash.C_EVTPowerBall.PowerBallSpriteEVT[0] = v1v366;
	int[] v1v419 = new int[8];
	v1v419[6] = 1;
	v1v419[7] = 5;
	com.game.UnicornDash.C_EVTPowerBall.PowerBallSpriteEVT[1] = v1v419;
	int[] v1v62 = new int[8];
	v1v62[6] = 2;
	v1v62[7] = 8;
	com.game.UnicornDash.C_EVTPowerBall.PowerBallSpriteEVT[2] = v1v62;
...
public C_EVTPowerBall(){
	super();
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTPowerBall.PowerBallACT;
	this.EVT.EVTPtr = com.game.UnicornDash.C_EVTPowerBall.PowerBallSpriteEVT;
}
...
private void PowerBallExe01(){
	...
	if (com.game.UnicornDash.C_PUB.Random(20) == 0) {
...
void CreatePowerBall(com.game.UnicornDash.C_EVTPowerBall c_PowerBall,int XVal,int YVal){
