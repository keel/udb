...
static{
	...
	v0v146[0] = com.game.UnicornDash.C_EVTPlayer.Plane00ACT;
	v0v146[1] = com.game.UnicornDash.C_EVTPlayer.Plane01ACT;
	v0v146[2] = com.game.UnicornDash.C_EVTPlayer.Plane02ACT;
	v0v146[3] = com.game.UnicornDash.C_EVTPlayer.Plane03ACT;
	v0v146[4] = com.game.UnicornDash.C_EVTPlayer.Plane04ACT;
	PlaneACT = v0v146;
	;
	int[] v2v171 = new int[8];
	v2v171[6] = 1;
	v2v171[7] = 11;
	com.game.UnicornDash.C_EVTPlayer.PLANEEVT[0] = v2v171;
	int[] v1v511 = new int[8];
	v1v511[6] = 1;
	v1v511[7] = 17;
	com.game.UnicornDash.C_EVTPlayer.PLANEEVT[1] = v1v511;
	int[] v1v867 = new int[8];
	v1v867[6] = 1;
	v1v867[7] = 6;
	com.game.UnicornDash.C_EVTPlayer.PLANEEVT[2] = v1v867;
	int[] v2v114 = new int[8];
	v2v114[6] = 1;
	v2v114[7] = 13;
	com.game.UnicornDash.C_EVTPlayer.PLANEEVT[3] = v2v114;
	int[] v2v143 = new int[8];
	v2v143[6] = 2;
	v2v143[7] = 16;
	com.game.UnicornDash.C_EVTPlayer.PLANEEVT[4] = v2v143;
...
public C_EVTPlayer(){
	...
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTPlayer.PlaneACT;
	this.EVT.EVTPtr = com.game.UnicornDash.C_EVTPlayer.PLANEEVT;
}
...
private void CHKGameOperate(){
	...
	if ((com.game.UnicornDash.C_Global.g_JumpBTNTouch & 0x4) == 4) {
	...
	if ((com.game.UnicornDash.C_Global.g_DashBTNTouch & 0x4) != 4 || this.c_EVTPlayer.m_DashDly != 0) {
...
private void PlayerExe01(){
	...
	if ((com.game.UnicornDash.C_Global.g_JumpBTNTouch & 0x2) == 2) {
	this.EVT.MaxCNT = 4;
	} else {
	this.EVT.MaxCNT = 1;
		}
...
private void PlayerExe04(){
	...
	this.EVT.Status = (this.EVT.Status | 0x400);
	if (this.CHKEVTACTEnd()) {
	com.game.UnicornDash.C_OPhoneApp.cLib.getMessageMgr().SendMessage(20,9,0);
	this.EVTCLR();
	// :cond_0
	}
	return;
...
private void chkGameSide(){
	...
	com.game.UnicornDash.C_OPhoneApp.cLib.getMessageMgr().SendMessage(40,45,0);
	// :cond_0
	}
	return;
}
...
public void CreatePlayer(){
	...
	this.c_EVTPlayer.MakeEVENT(240,(80 - com.game.UnicornDash.C_Global.g_ScreenScale_3_1),0);
...
public void InitPlaneOBJ(com.game.UnicornDash.C_EVTPlayer cEVTPlayer){
...
public void setPlayerCtrl(int Ctrl,int Mode){
	...
	com.game.UnicornDash.C_OPhoneApp.cLib.getMessageMgr().SendMessage(40,45,0);
	com.game.UnicornDash.C_OPhoneApp.cLib.getMessageMgr().SendMessage(40,49,0);
	break;
	} //end of switch
	// :cond_1
	}
