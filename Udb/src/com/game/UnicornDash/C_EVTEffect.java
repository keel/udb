...
public static final double[] CloudScaleCTBL = {0x3fe999999999999aL,0x3feccccccccccccdL,0x3ff0000000000000L,0x3ff199999999999aL,0x3ff3333333333333L,0x3ff4cccccccccccdL,0x3ff6666666666666L,0x3ff8000000000000L};
...
static{
	...
	v0v140[0] = com.game.UnicornDash.C_EVTEffect.Effect00ACT;
	v0v140[1] = com.game.UnicornDash.C_EVTEffect.Effect01ACT;
	v0v140[2] = com.game.UnicornDash.C_EVTEffect.Effect02ACT;
	v0v140[3] = com.game.UnicornDash.C_EVTEffect.Effect03ACT;
	EffectACT = v0v140;
	;
	int[] v2v134 = new int[8];
	v2v134[6] = 1;
	v2v134[7] = 8;
	com.game.UnicornDash.C_EVTEffect.EFFECTEVT[0] = v2v134;
	int[] v1v472 = new int[8];
	v1v472[6] = 3;
	v1v472[7] = 8;
	com.game.UnicornDash.C_EVTEffect.EFFECTEVT[1] = v1v472;
	int[] v2v182 = new int[8];
	v2v182[6] = 3;
	v2v182[7] = 8;
	com.game.UnicornDash.C_EVTEffect.EFFECTEVT[2] = v2v182;
	int[] v1v533 = new int[8];
	v1v533[6] = 3;
	v1v533[7] = 1;
	com.game.UnicornDash.C_EVTEffect.EFFECTEVT[3] = v1v533;
...
public C_EVTEffect(){
	...
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTEffect.EffectACT;
	this.EVT.EVTPtr = com.game.UnicornDash.C_EVTEffect.EFFECTEVT;
}
...
private void Effect01(){
	...
	com.game.UnicornDash.C_PUB.ShowNum((this.m_Score * 0x64),(XVal + SceneFloat_X),(YVal + SceneFloat_Y),15,3,5,com.game.UnicornDash.C_DEF.ResultNUM1TBL,this.EVT.Attrib);
	} else {
	com.game.UnicornDash.C_PUB.ShowNum((this.m_Score * 0x64),(XVal + SceneFloat_X),(YVal + SceneFloat_Y),12,3,5,com.game.UnicornDash.C_DEF.ResultNUM2TBL,this.EVT.Attrib);
		}
	// goto :goto_0
	// :goto_0
	if (this.CHKEVTACTEnd()) {
...
private void Effect02(){
	...
	int SceneFloat_X = 0;
	int SceneFloat_Y = 0;
	com.game.UnicornDash.C_PUB.ShowNum((this.m_Score * 0xa),(XVal + SceneFloat_X),(YVal + SceneFloat_Y),15,2,5,com.game.UnicornDash.C_DEF.ResultNUM2TBL,this.EVT.Attrib);
	if (this.CHKEVTACTEnd()) {
	this.EVTCLR();
	// :cond_0
	}
...
public void CreateCloud_Eff(int XVal,int YVal,int Speed){
	if (com.game.UnicornDash.C_Global.g_chkVersion != 1) {
	return;
	// :cond_1
	} else if (com.game.UnicornDash.C_Global.g_MakeCloudDly != 0) {
	com.game.UnicornDash.C_Global.g_MakeCloudDly = (com.game.UnicornDash.C_Global.g_MakeCloudDly - 1);
	// goto :goto_0
	} else {
	com.game.UnicornDash.C_Global.g_MakeCloudDly = (com.game.UnicornDash.C_PUB.Random(120) + 0x40);
	int i = 0;
	while (i < 10) {
	if (!this.c_EVTEffect[i].EVT.Valid) {
	XVal = (com.game.UnicornDash.C_PUB.Random(160) + 0x28);
	YVal = 680;
...
public void CreateEidolonScore_Eff(int XVal,int YVal,int Score){
	...
	while (i < 10) {
	if (!this.c_EVTEffect[i].EVT.Valid) {
	this.c_EVTEffect[i].MakeEVENT((com.game.UnicornDash.C_Global.g_SceneFloat_X + XVal),(com.game.UnicornDash.C_Global.g_SceneFloat_Y + YVal),0);
...
public void InitEffectOBJ(com.game.UnicornDash.C_EVTEffect[] cEVTEffect){
