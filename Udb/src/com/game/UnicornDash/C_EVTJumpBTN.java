...
static{
	;
	int[][] v0v58 = new int[2][];
	v0v58[0] = com.game.UnicornDash.C_EVTJumpBTN.BTN_Jump00;
	v0v58[1] = com.game.UnicornDash.C_EVTJumpBTN.BTN_Jump00;
	BTN_JumpACT = v0v58;
	;
	int[] v1v552 = new int[8];
	v1v552[6] = 4;
	v1v552[7] = 1;
	com.game.UnicornDash.C_EVTJumpBTN.JumpBTNSpriteEVT[0] = v1v552;
	int[] v1v436 = new int[8];
	v1v436[6] = 4;
	v1v436[7] = 2;
	com.game.UnicornDash.C_EVTJumpBTN.JumpBTNSpriteEVT[1] = v1v436;
...
public C_EVTJumpBTN(){
	super();
	this.m_BTNType = 0 /* 0 */;
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTJumpBTN.BTN_JumpACT;
	this.EVT.EVTPtr = com.game.UnicornDash.C_EVTJumpBTN.JumpBTNSpriteEVT;
}
...
private void JumpBTNTouch(){
	...
	com.game.UnicornDash.C_Global.g_JumpBTNTouch = (com.game.UnicornDash.C_Global.g_JumpBTNTouch | 0x4);
	this.EVT.CurCNT = 0 /* 0 */;
	this.EVT.CurFRM = 1;
	// :cond_0
	}
	if (com.game.UnicornDash.C_PUB.CHKIsTouch(2,2,2,2,ACTName,XVal,YVal)) {
	com.game.UnicornDash.C_Global.g_JumpBTNTouch = (com.game.UnicornDash.C_Global.g_JumpBTNTouch | 0x2);
	this.EVT.CurCNT = 0 /* 0 */;
	this.EVT.CurFRM = 1;
	// :cond_1
	}
...
public void CreateJumpBTN(com.game.UnicornDash.C_EVTJumpBTN c_JumpBTN,int XVal,int YVal){
