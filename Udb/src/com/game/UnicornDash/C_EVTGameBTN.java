...
static{
	...
	v0v321[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_Play00;
	v0v321[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_Play00;
	BTN_PlayACT = v0v321;
	int[][] v0v39 = new int[2][];
	v0v39[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_More00;
	v0v39[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_More00;
	BTN_MoreACT = v0v39;
	int[][] v0v361 = new int[2][];
	v0v361[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_Pause00;
	v0v361[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_Pause00;
	BTN_PauseACT = v0v361;
	int[][] v0v376 = new int[2][];
	v0v376[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_Resume00;
	v0v376[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_Resume00;
	BTN_ResumeACT = v0v376;
	int[][] v0v325 = new int[2][];
	v0v325[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_Quit00;
	v0v325[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_Quit00;
	BTN_QuitACT = v0v325;
	int[][] v0v388 = new int[2][];
	v0v388[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundON00;
	v0v388[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundON00;
	BTN_SoundONACT = v0v388;
	int[][] v0v342 = new int[2][];
	v0v342[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundOFF00;
	v0v342[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundOFF00;
	BTN_SoundOFFACT = v0v342;
	int[][] v0v365 = new int[2][];
	v0v365[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicON00;
	v0v365[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicON00;
	BTN_MusicONACT = v0v365;
	int[][] v0v344 = new int[2][];
	v0v344[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicOFF00;
	v0v344[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicOFF00;
	BTN_MusicOFFACT = v0v344;
	int[][] v0v31 = new int[2][];
	v0v31[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeON00;
	v0v31[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeON00;
	BTN_ShakeONACT = v0v31;
	int[][] v0v322 = new int[2][];
	v0v322[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeOFF00;
	v0v322[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeOFF00;
	BTN_ShakeOFFACT = v0v322;
	int[][] v0v389 = new int[2][];
	v0v389[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_BuyNow00;
	v0v389[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_BuyNow00;
	BTN_BuyNowACT = v0v389;
	int[][] v0v398 = new int[2][];
	v0v398[0] = com.game.UnicornDash.C_EVTGameBTN.BTN_MaybeLater00;
	v0v398[1] = com.game.UnicornDash.C_EVTGameBTN.BTN_MaybeLater00;
	BTN_MaybeLaterACT = v0v398;
	;
	int[] v1v31 = new int[8];
	v1v31[6] = 4;
	v1v31[7] = 1;
	com.game.UnicornDash.C_EVTGameBTN.GameBTNSpriteEVT[0] = v1v31;
	int[] v1v488 = new int[8];
	v1v488[6] = 2;
	v1v488[7] = 4;
	com.game.UnicornDash.C_EVTGameBTN.GameBTNSpriteEVT[1] = v1v488;
...
public C_EVTGameBTN(){
	...
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_PauseACT;
	this.EVT.EVTPtr = com.game.UnicornDash.C_EVTGameBTN.GameBTNSpriteEVT;
}
...
private void GameBTNExe00(){
	...
	if (!com.game.UnicornDash.C_Global.g_BtnIsValid) {
	// :cond_0
	// :cond_1
	} else if (com.game.UnicornDash.C_PUB.CHKTouchDown(2,2,2,2,ACTName,XVal,YVal)) {
	...
	com.game.UnicornDash.C_Global.g_BtnIsValid = false /* 0 */;
	} //end of switch
		}
	// goto :goto_0
...
private void GameBTNExe01(){
	...
	com.game.UnicornDash.C_OPhoneApp.cLib.getMessageMgr().SendMessage(10,this.m_BTNType,0);
	this.SetEVTCtrl(0,0);
	// :cond_0
	}
	return;
...
private void SetGameBTNType(int Idx,int type){
	switch(type){
	case 9: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_PlayACT;
	break;
	case 10: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_MoreACT;
	break;
	case 6: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_PauseACT;
	break;
	case 7: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_ResumeACT;
	break;
	case 8: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_QuitACT;
	break;
	case 3: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundONACT;
	break;
	case 4: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicONACT;
	break;
	case 5: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeONACT;
	break;
	case 12: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_BuyNowACT;
	break;
	case 13: 
	this.c_EVTGameBTN[Idx].EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_MaybeLaterACT;
	break;
	} //end of switch
	//:pswitch_0
	return;
...
private void setSoundBNTACT(){
	...
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundONACT;
	} else {
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_SoundOFFACT;
		}
	// goto :goto_0
	// :cond_0
	}
	...
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicONACT;
	} else {
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_MusicOFFACT;
		}
	// goto :goto_1
	// :cond_1
	}
	...
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeONACT;
	} else {
	this.EVT.ACTPtr = com.game.UnicornDash.C_EVTGameBTN.BTN_ShakeOFFACT;
		}
	// goto :goto_2
	// :cond_2
	}
...
public void CreateGameBTN(int BTNType,int XVal,int YVal){
	...
	com.game.UnicornDash.C_Global.g_BtnIsValid = true;
	// goto :goto_1
break ; //
	} else {
	i = (i + 0x1);
...
public void InitGameBTNOBJ(com.game.UnicornDash.C_EVTGameBTN[] cEVTGameBTN){
